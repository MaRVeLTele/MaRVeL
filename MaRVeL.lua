------------------------------------------------
-- This Source Was Developed By (MaRVeL) @Too_9.--
--   This Is The Source Channel @Too_9 .   --
--                - Source MaRVeL-                 --
--        -- https://t.me/Too_9 --         --
------------------------------------------------ 
...
local TheMaRVeL = io.open("TheMaRVeL", 'w')
TheMaRVeL:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 MaRVeL.lua
done
]])
TheMaRVeL:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheMaRVeL -X kill
screen -S TheMaRVeL ./TheMaRVeL
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheMaRVeL;chmod +x Run;./Run')
end
...
TheMaRVeL = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheMaRVeL)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheMaRVeL,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,7114510192}  
...
if UserId == 7114510192 then
Status = true
elseif UserId == 7114510192 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif UserId == TheMaRVeL then
Status = true
...
Status = 0
Developers = Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..ChatId,UserId)
...
Status = Redis:get(TheMaRVeL.."MaRVeL:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(TheMaRVeL.."MaRVeL:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(TheMaRVeL.."MaRVeL:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheMaRVeL.."MaRVeL:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheMaRVeL.."MaRVeL:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheMaRVeL.."MaRVeL:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheMaRVeL.."MaRVeL:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheMaRVeL.."MaRVeL:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheMaRVeL.."MaRVeL:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheMaRVeL.."MaRVeL:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheMaRVeL.."MaRVeL:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheMaRVeL.."MaRVeL:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheMaRVeL.."MaRVeL:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[- L u c i f e r 🦇.](https://t.me/II_T9)\n*━─━─━─━─━─━─━\n⌔︰بواسطه ˓ *'..UserInfousername..'\n*'..TextMsg..'\n⌔︰خاصيه المسح *',
unLock   = '[- L u c i f e r 🦇.](https://t.me/II_T9)\n*━─━─━─━─━─━─━\n⌔︰بواسطه ˓ *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- L u c i f e r 🦇.](https://t.me/II_T9)\n*━─━─━─━─━─━─━\n⌔︰بواسطه ˓ *'..UserInfousername..'\n*'..TextMsg..'\n⌔︰خاصيه الكتم *',
lockKid  = '[- L u c i f e r 🦇.](https://t.me/II_T9)\n*━─━─━─━─━─━─━\n⌔︰بواسطه ˓ *'..UserInfousername..'\n*'..TextMsg..'\n⌔︰خاصيه التقييد *',
lockKick = '[- L u c i f e r 🦇.](https://t.me/II_T9II_T9)\n*━─━─━─━─━─━─━\n⌔︰بواسطه ˓ *'..UserInfousername..'\n*'..TextMsg..'\n⌔︰خاصيه الطرد *',
Reply    = '[- L u c i f e r 🦇.](https://t.me/II_T9)\n*━─━─━─━─━─━─━\n⌔︰المستخدم ˓ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheMaRVeL).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheMaRVeL..'MaRVeL:Channel:Join')
if Channel then
...
if tonumber(msg.sender.user_id) == tonumber(TheMaRVeL) then
...
if tonumber(msg.sender.user_id) == 7114510192 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 7114510192 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif The_ControllerAll(msg.sender.user_id) == true then  
msg.The_Controller = 1
msg.Name_Controller = 'المطور الاساسي '
elseif Redis:sismember(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheMaRVeL.."MaRVeL:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheMaRVeL.."MaRVeL:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheMaRVeL.."MaRVeL:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheMaRVeL.."MaRVeL:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheMaRVeL.."MaRVeL:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheMaRVeL.."MaRVeL:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheMaRVeL.."MaRVeL:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheMaRVeL) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheMaRVeL.."MaRVeL:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheMaRVeL.."MaRVeL:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheMaRVeL.."MaRVeL:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheMaRVeL.."MaRVeL:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheMaRVeL) then
return false
end
local floods = Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheMaRVeL.."MaRVeL:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheMaRVeL.."MaRVeL:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheMaRVeL.."MaRVeL:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheMaRVeL.."MaRVeL:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheMaRVeL.."MaRVeL:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheMaRVeL.."MaRVeL:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheMaRVeL.."MaRVeL:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheMaRVeL.."MaRVeL:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheMaRVeL.."MaRVeL:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TheMaRVeL.."MaRVeL:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Unsupported"..msg_chat_id)
...
local Audio_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheMaRVeL.."MaRVeL:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheMaRVeL.."MaRVeL:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheMaRVeL.."MaRVeL:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheMaRVeL.."MaRVeL:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheMaRVeL..'MaRVeL:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheMaRVeL.."MaRVeL:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheMaRVeL.."MaRVeL:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheMaRVeL.."MaRVeL:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheMaRVeL.."MaRVeL:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheMaRVeL..'MaRVeL:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheMaRVeL..'MaRVeL:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheMaRVeL.."MaRVeL:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheMaRVeL.."MaRVeL:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheMaRVeL.."MaRVeL:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheMaRVeL..'MaRVeL:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheMaRVeL..'MaRVeL:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheMaRVeL.."MaRVeL:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheMaRVeL.."MaRVeL:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheMaRVeL.."MaRVeL:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheMaRVeL.."MaRVeL:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheMaRVeL..'MaRVeL:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheMaRVeL.."MaRVeL:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheMaRVeL.."MaRVeL:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheMaRVeL.."MaRVeL:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheMaRVeL.."MaRVeL:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheMaRVeL.."MaRVeL:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheMaRVeL.."MaRVeL:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheMaRVeL.."MaRVeL:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheMaRVeL.."MaRVeL:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheMaRVeL.."MaRVeL:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheMaRVeL.."MaRVeL:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheMaRVeL.."MaRVeL:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheMaRVeL.."MaRVeL:Command:List:Group"..msg_chat_id,text)
Redis:del(TheMaRVeL.."MaRVeL:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم حفظ الامر باسم ˓ { "..text..' }',"md",true)
end
if Redis:get(TheMaRVeL.."MaRVeL:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheMaRVeL.."MaRVeL:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheMaRVeL.."MaRVeL:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheMaRVeL.."MaRVeL:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︰تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheMaRVeL.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheMaRVeL.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheMaRVeL.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheMaRVeL.."MaRVeL:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheMaRVeL.."MaRVeL:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheMaRVeL.."MaRVeL:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheMaRVeL.."MaRVeL:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheMaRVeL.."MaRVeL:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheMaRVeL.."MaRVeL:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheMaRVeL.."MaRVeL:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheMaRVeL.."MaRVeL:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheMaRVeL.."MaRVeL:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheMaRVeL.."MaRVeL:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم حفظ رد للمدير بنجاح \n⌔︰ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheMaRVeL.."MaRVeL:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheMaRVeL.."MaRVeL:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheMaRVeL.."MaRVeL:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheMaRVeL.."MaRVeL:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '- L u c i f e r 🦇. ⁦', url='https://t.me/II_T9'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(TheMaRVeL.."MaRVeL:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheMaRVeL.."MaRVeL:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheMaRVeL.."MaRVeL:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheMaRVeL..'MaRVeL:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheMaRVeL..'MaRVeL:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheMaRVeL.."MaRVeL:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheMaRVeL..'MaRVeL:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheMaRVeL.."MaRVeL:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheMaRVeL.."MaRVeL:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheMaRVeL.."MaRVeL:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheMaRVeL.."MaRVeL:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheMaRVeL.."MaRVeL:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheMaRVeL.."MaRVeL:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheMaRVeL.."MaRVeL:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheMaRVeL.."MaRVeL:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheMaRVeL..'MaRVeL:'..v..text)
end
Redis:del(TheMaRVeL.."MaRVeL:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheMaRVeL.."MaRVeL:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheMaRVeL.."MaRVeL:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMaRVeL.."MaRVeL:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheMaRVeL.."MaRVeL:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheMaRVeL.."MaRVeL:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheMaRVeL.."MaRVeL:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheMaRVeL.."MaRVeL:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheMaRVeL.."MaRVeL:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheMaRVeL.."MaRVeL:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheMaRVeL.."MaRVeL:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheMaRVeL.."MaRVeL:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheMaRVeL.."MaRVeL:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheMaRVeL.."MaRVeL:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheMaRVeL.."MaRVeL:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMaRVeL.."MaRVeL:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheMaRVeL..'MaRVeL:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheMaRVeL.."MaRVeL:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMaRVeL.."MaRVeL:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheMaRVeL.."MaRVeL:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheMaRVeL.."MaRVeL:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMaRVeL.."MaRVeL:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheMaRVeL.."MaRVeL:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMaRVeL.."MaRVeL:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheMaRVeL..'MaRVeL:GetTexting:DevTheMaRVeL'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheMaRVeL..'MaRVeL:GetTexting:DevTheMaRVeL'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰تم الغاء حفظ كليشة المطور')
end
Redis:set(TheMaRVeL..'MaRVeL:Texting:DevTheMaRVeL',text)
Redis:del(TheMaRVeL..'MaRVeL:GetTexting:DevTheMaRVeL'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰تم حفظ كليشة المطور')
end
if Redis:get(TheMaRVeL.."MaRVeL:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TheMaRVeL.."MaRVeL:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheMaRVeL.."MaRVeL:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheMaRVeL.."MaRVeL:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰ تم تعين الايدي عام',"md",true)  
end
if Redis:get(TheMaRVeL.."MaRVeL:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheMaRVeL.."MaRVeL:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheMaRVeL.."MaRVeL:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheMaRVeL.."MaRVeL:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TheMaRVeL.."MaRVeL:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMaRVeL.."MaRVeL:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheMaRVeL.."MaRVeL:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheMaRVeL.."MaRVeL:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔︰ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheMaRVeL.."MaRVeL:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMaRVeL.."MaRVeL:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheMaRVeL.."MaRVeL:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheMaRVeL.."MaRVeL:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔︰ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheMaRVeL.."MaRVeL:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheMaRVeL.."MaRVeL:Game:Smile"..msg.chat_id) then
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMaRVeL.."MaRVeL:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰لقد فزت في اللعبه \n⌔︰اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(TheMaRVeL.."MaRVeL:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheMaRVeL.."MaRVeL:Game:Monotonous"..msg.chat_id) then
Redis:del(TheMaRVeL.."MaRVeL:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰لقد فزت في اللعبه \n⌔︰اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  

end
end 
if Redis:get(TheMaRVeL.."MaRVeL:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheMaRVeL.."MaRVeL:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMaRVeL.."MaRVeL:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰لقد فزت في اللعبه \n⌔︰اللعب مره اخره وارسل - حزوره","md",true)  

end
end
if Redis:get(TheMaRVeL.."MaRVeL:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheMaRVeL.."MaRVeL:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMaRVeL.."MaRVeL:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰لقد فزت في اللعبه \n⌔︰اللعب مره اخره وارسل - معاني","md",true)  

end
end
if Redis:get(TheMaRVeL.."MaRVeL:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheMaRVeL.."MaRVeL:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMaRVeL.."MaRVeL:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰لقد فزت في اللعبه \n⌔︰اللعب مره اخره وارسل - العكس","md",true)  

end
end
if Redis:get(TheMaRVeL.."MaRVeL:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheMaRVeL.."MaRVeL:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheMaRVeL.."MaRVeL:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMaRVeL.."MaRVeL:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︰تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheMaRVeL.."MaRVeL:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheMaRVeL.."MaRVeL:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheMaRVeL.."MaRVeL:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMaRVeL.."MaRVeL:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheMaRVeL.."MaRVeL:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheMaRVeL.."MaRVeL:Game:Difference"..msg.chat_id) then 
Redis:del(TheMaRVeL.."MaRVeL:Game:Difference"..msg.chat_id)
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheMaRVeL.."MaRVeL:Game:Example"..msg.chat_id) then
if text == Redis:get(TheMaRVeL.."MaRVeL:Game:Example"..msg.chat_id) then 
Redis:del(TheMaRVeL.."MaRVeL:Game:Example"..msg.chat_id)
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if tonumber(TheMaRVeL) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheMaRVeL..'MaRVeL:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheMaRVeL.."MaRVeL:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheMaRVeL.."MaRVeL:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheMaRVeL.."MaRVeL:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheMaRVeL.."MaRVeL:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheMaRVeL.."MaRVeL:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheMaRVeL) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheMaRVeL.."MaRVeL:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheMaRVeL.."MaRVeL:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheMaRVeL.."MaRVeL:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheMaRVeL.."MaRVeL:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheMaRVeL..'MaRVeL:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(TheMaRVeL..'MaRVeL:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheMaRVeL).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheMaRVeL..'MaRVeL:Channel:Join',ChannelUser) 
...
Redis:set(TheMaRVeL..'MaRVeL:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheMaRVeL..'MaRVeL:Channel:Join')
...
os.execute('rm -rf MaRVeL.lua')
download('https://raw.githubusercontent.com/MaRVeLTele/MaRVeL/main/MaRVeL.lua','MaRVeL.lua')
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheMaRVeL..'MaRVeL:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheMaRVeL..'MaRVeL:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
end
Redis:del(TheMaRVeL.."MaRVeL:SendBcBot") 
...
Redis:set(TheMaRVeL.."MaRVeL:SendBcBot",true) 
...
Redis:del(TheMaRVeL.."MaRVeL:LeftBot") 
...
Redis:set(TheMaRVeL.."MaRVeL:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TheMaRVeL.."MaRVeL:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheMaRVeL.."MaRVeL:AddSudosNew"..msg_chat_id)
...
Redis:set(TheMaRVeL.."MaRVeL:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(TheMaRVeL..'MaRVeL:ChekBotAdd')  
local UsersBot = Redis:smembers(TheMaRVeL..'MaRVeL:Num:User:Pv')  
local Get_Json = '{"BotId": '..TheMaRVeL..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheMaRVeL.."MaRVeL:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheMaRVeL.."MaRVeL:Originators:Group"..v)
local Manager = Redis:smembers(TheMaRVeL.."MaRVeL:Managers:Group"..v)
local Admin = Redis:smembers(TheMaRVeL.."MaRVeL:Addictive:Group"..v)
local Vips = Redis:smembers(TheMaRVeL.."MaRVeL:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheMaRVeL.."MaRVeL:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheMaRVeL.."MaRVeL:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheMaRVeL.."MaRVeL:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(TheMaRVeL..'MaRVeL:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*⌔︰عدد احصائيات البوت الكامله \n━─━─━─━─━─━─━\n⌔︰عدد المجموعات : '..(Redis:scard(TheMaRVeL..'MaRVeL:ChekBotAdd') or 0)..'\n⌔︰عدد المشتركين : '..(Redis:scard(TheMaRVeL..'MaRVeL:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(TheMaRVeL.."MaRVeL:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheMaRVeL..'MaRVeL:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheMaRVeL..'MaRVeL:Num:Add:Bot'),"md",true)  
end
...
data = {
{
{text = '٬ 𝗋𝖺𝗂𝗌𝖾 𝖺𝖽𝗆𝗂𝗇𝗌 † ٫', data = msg.sender.user_id..'/addAdmins@'..msg_chat_id},{text = '٬ 𝖺𝖼𝗍𝗂𝗏𝖺𝗍𝗂𝗇𝗀 𝗉𝗋𝗈𝗍𝖾𝖼𝗍𝗂𝗈𝗇 † ٫', data =msg.sender.user_id..'/LockAllGroup@'..msg_chat_id},
},
{
...
Redis:sadd(TheMaRVeL.."MaRVeL:ChekBotAdd",msg_chat_id)
Redis:set(TheMaRVeL.."MaRVeL:Status:Id"..msg_chat_id,true) ;Redis:set(TheMaRVeL.."MaRVeL:Status:Reply"..msg_chat_id,true) ;Redis:set(TheMaRVeL.."MaRVeL:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheMaRVeL.."MaRVeL:Status:BanId"..msg_chat_id,true) ;Redis:set(TheMaRVeL.."MaRVeL:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheMaRVeL.."MaRVeL:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheMaRVeL.."MaRVeL:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:ChekBotAdd",msg_chat_id)
...
local TotalMsg = Redis:get(TheMaRVeL..'MaRVeL:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheMaRVeL..'MaRVeL:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔︰ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheMaRVeL..'MaRVeL:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheMaRVeL..'MaRVeL:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔︰ايديه : '..UserId..
'\n⌔︰معرفه : @'..UserName..
...
Redis:set(TheMaRVeL.."MaRVeL:Set:Id:Group"..msg.chat_id,Text_Rand)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheMaRVeL).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheMaRVeL).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*⌔︰تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"*⌔︰تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Developers:Groups",UserId) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheMaRVeL.."MaRVeL:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Developers:Groups",UserId) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︰تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheMaRVeL.."MaRVeL:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMaRVeL.."MaRVeL:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMaRVeL.."MaRVeL:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMaRVeL.."MaRVeL:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheMaRVeL.."MaRVeL:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMaRVeL.."MaRVeL:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⌔︰قائمه مطورين البوت \n ━─━─━─━─━─━─━*\n'
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheMaRVeL.."MaRVeL:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheMaRVeL.."MaRVeL:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheMaRVeL.."MaRVeL:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheMaRVeL.."MaRVeL:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheMaRVeL.."MaRVeL:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheMaRVeL.."MaRVeL:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheMaRVeL.."MaRVeL:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheMaRVeL.."MaRVeL:BotFree",true) 
...
Redis:set(TheMaRVeL.."MaRVeL:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheMaRVeL.."MaRVeL1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(TheMaRVeL.."MaRVeL1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheMaRVeL.."MaRVeL1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheMaRVeL.."MaRVeL1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheMaRVeL.."MaRVeL1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheMaRVeL..'MaRVeL1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheMaRVeL..'MaRVeL1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheMaRVeL..'MaRVeL1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheMaRVeL.."MaRVeL1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheMaRVeL.."MaRVeL1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheMaRVeL.."MaRVeL1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheMaRVeL.."MaRVeL1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheMaRVeL.."MaRVeL1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheMaRVeL.."MaRVeL1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheMaRVeL.."MaRVeL1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheMaRVeL.."MaRVeL1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheMaRVeL.."MaRVeL1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheMaRVeL.."MaRVeL1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMaRVeL.."MaRVeL1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheMaRVeL.."MaRVeL1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMaRVeL.."MaRVeL1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheMaRVeL.."MaRVeL1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMaRVeL.."MaRVeL1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheMaRVeL.."MaRVeL1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMaRVeL.."MaRVeL1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheMaRVeL.."MaRVeL1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMaRVeL.."MaRVeL1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheMaRVeL.."MaRVeL1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMaRVeL.."MaRVeL1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheMaRVeL.."MaRVeL1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheMaRVeL.."MaRVeL1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheMaRVeL.."MaRVeL1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheMaRVeL.."MaRVeL11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheMaRVeL.."MaRVeL11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheMaRVeL.."MaRVeL11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheMaRVeL.."MaRVeL11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMaRVeL.."MaRVeL11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheMaRVeL..'MaRVeL11:Add:Rd:Sudo:Text'..text)
Redis:del(TheMaRVeL..'MaRVeL11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheMaRVeL..'MaRVeL11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheMaRVeL.."MaRVeL11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheMaRVeL.."MaRVeL11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheMaRVeL.."MaRVeL11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheMaRVeL.."MaRVeL11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheMaRVeL.."MaRVeL11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheMaRVeL.."MaRVeL11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheMaRVeL.."MaRVeL11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheMaRVeL.."MaRVeL11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheMaRVeL.."MaRVeL11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheMaRVeL.."MaRVeL11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMaRVeL.."MaRVeL11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheMaRVeL.."MaRVeL11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMaRVeL.."MaRVeL11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheMaRVeL.."MaRVeL11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMaRVeL.."MaRVeL11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheMaRVeL.."MaRVeL11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMaRVeL.."MaRVeL11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheMaRVeL.."MaRVeL11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMaRVeL.."MaRVeL11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheMaRVeL.."MaRVeL11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMaRVeL.."MaRVeL11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheMaRVeL.."MaRVeL11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheMaRVeL.."MaRVeL11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheMaRVeL.."MaRVeL11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheMaRVeL.."MaRVeL:allM"..msg.chat_id, msg.id)
if Redis:get(TheMaRVeL.."MaRVeL:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheMaRVeL.."MaRVeL:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheMaRVeL.."MaRVeL:allM"..msg.chat_id)
...
Redis:del(TheMaRVeL.."MaRVeL:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheMaRVeL.."MaRVeL:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheMaRVeL.."MaRVeL:allM"..msg.chat_id)  
...
Redis:del(TheMaRVeL.."MaRVeL:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheMaRVeL.."MaRVeL:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheMaRVeL.."MaRVeL:Status:yt"..msg.chat_id)
...
Redis:set(TheMaRVeL.."MaRVeL:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheMaRVeL.."MaRVeL:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TheMaRVeL.."MaRVeL:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheMaRVeL.."MaRVeL:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Status:Id"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Status:Reply"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Status:BanId"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:BotFree") 
...
Redis:del(TheMaRVeL.."MaRVeL:TwaslBot") 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:BanAll:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '٬ 𝖼𝗅𝗂𝖼𝗄 𝗍𝗈 𝗌𝗎𝖻𝗌𝖼𝗋𝗂𝖻𝖾 † ٫ ', url = 't.me/II_T9'}, },}}
...
if Redis:sismember(TheMaRVeL.."MaRVeL:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheMaRVeL.."MaRVeL:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheMaRVeL.."MaRVeL:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMaRVeL.."MaRVeL:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMaRVeL.."MaRVeL:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheMaRVeL.."MaRVeL:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMaRVeL.."MaRVeL:BanAll:Groups",UserId) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:BanAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم الغاء حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:BanAll:Groups",UserId) 
...
if Redis:sismember(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheMaRVeL.."MaRVeL:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if not msg.ControllerBot and not Redis:set(TheMaRVeL.."MaRVeL:LeftBot") then
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheMaRVeL.."MaRVeL:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheMaRVeL..'MaRVeL:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:text"..msg_chat_id)  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Join"..msg_chat_id)  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheMaRVeL.."MaRVeL:lockpin"..msg_chat_id)  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:edit"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheMaRVeL..'MaRVeL:'..lock..msg_chat_id)    
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- L u c i f e r 🦇.- L u c i f e r 🦇.',url="t.me/II_T9"}},
}
local msg_id = msg.id/2097152/0.5
...
Redis:hset(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheMaRVeL.."MaRVeL:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Link"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Video"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:geam"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:vico"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:forward"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Document"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheMaRVeL.."MaRVeL:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheMaRVeL.."MaRVeL:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheMaRVeL.."MaRVeL:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheMaRVeL.."MaRVeL:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheMaRVeL.."MaRVeL:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheMaRVeL.."MaRVeL:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
Redis:setex(TheMaRVeL.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheMaRVeL.."MaRVeL:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheMaRVeL.."MaRVeL:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheMaRVeL.."MaRVeL:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheMaRVeL.."MaRVeL:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheMaRVeL.."MaRVeL:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheMaRVeL.."MaRVeL:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheMaRVeL.."MaRVeL:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheMaRVeL.."MaRVeL:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheMaRVeL.."MaRVeL:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheMaRVeL.."MaRVeL:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheMaRVeL..'MaRVeL:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheMaRVeL..'MaRVeL:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︰ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheMaRVeL.."MaRVeL:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheMaRVeL.."MaRVeL:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheMaRVeL.."MaRVeL:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheMaRVeL.."MaRVeL:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheMaRVeL.."MaRVeL:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheMaRVeL.."MaRVeL:Status:AddMe"..msg.chat_id) then
...
{
{text = '- ⤹ ٰ𝖱ِ𝖊َ𝖳ِ𝖚ٍ𝐑ِɴ 🔁. ', data =msg.sender.user_id..'/'.. 'NextSeting'}
},
{
{text = '٬ 𝗁𝗂𝖽𝖾 𝗂𝗍 † ٫', data =msg.sender.user_id..'/'.. 'delAmr'}
},
...
Rink = 1
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheMaRVeL..'MaRVeL:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheMaRVeL..'MaRVeL:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheMaRVeL..'MaRVeL:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عدد رسائلك هنا *~ '..(Redis:get(TheMaRVeL..'MaRVeL:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عدد التعديلات هنا *~ '..(Redis:get(TheMaRVeL..'MaRVeL:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عدد جهاتك المضافه هنا *~ '..(Redis:get(TheMaRVeL.."MaRVeL:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheMaRVeL.."MaRVeL:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⌔︰ ارسل الان النص
⌔︰ يمكنك اضافه :
...
Redis:del(TheMaRVeL.."MaRVeL:Set:Id:Groups")
...
Redis:setex(TheMaRVeL.."MaRVeL:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⌔︰ارسل الان النص
⌔︰يمكنك اضافه :
⌔︰`#username` » اسم المستخدم
...
Redis:del(TheMaRVeL.."MaRVeL:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheMaRVeL.."MaRVeL:DevelopersQ:Groups") 
...
Redis:del(TheMaRVeL.."MaRVeL:Developers:Groups") 
...
Redis:del(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Originators:Group"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Managers:Group"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:BanAll:Groups") 
...
Redis:del(TheMaRVeL.."MaRVeL:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheMaRVeL.."MaRVeL:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheMaRVeL.."MaRVeL:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheMaRVeL.."MaRVeL:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheMaRVeL.."MaRVeL:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheMaRVeL.."MaRVeL:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheMaRVeL.."MaRVeL:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:vico"..v)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Text"..v)   
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Photo"..v)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Video"..v)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:File"..v)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Audio"..v)
Redis:del(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:video_note"..v)
Redis:del(TheMaRVeL.."MaRVeL:List:Rd:Sudo")
end
...
text = "\n📝︰قائمة ردود المطور \n━─━─━─━─━─━─━\n"
for k,v in pairs(list) do
if Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheMaRVeL.."MaRVeL:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheMaRVeL.."MaRVeL:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheMaRVeL.."MaRVeL:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheMaRVeL.."MaRVeL:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︰ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMaRVeL.."MaRVeL:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︰ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMaRVeL.."MaRVeL:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︰ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMaRVeL.."MaRVeL:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheMaRVeL.."MaRVeL:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheMaRVeL..'MaRVeL:GetTexting:DevTheMaRVeL'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheMaRVeL..'MaRVeL:Texting:DevTheMaRVeL')
...
local UserId_Info = LuaTele.searchPublicChat("Too_9")
...
if not Redis:get(TheMaRVeL.."MaRVeL:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheMaRVeL.."MaRVeL:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(TheMaRVeL.."MaRVeL:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
local ban_ns = 'ᯏ'
if photo.total_count > 0 then
...
video = "https://t.me/II_T0/459"
local T =[[
Welcome to Source : [- L u c i f e r 🦇.](https://t.me/II_T9)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '- L u c i f e r 🦇.', url = "https://t.me/II_T0"}
},
}
local msgg = msg_id/2097152/0.5
...
return LuaTele.sendText(msg_chat_id,msg_id, [[*
٬ 𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝖽𝖾𝖺𝗋 𝗍𝗈 𝗒𝗈𝗎 𝖺𝖽𝗏𝖺𝗇𝖼𝖾𝖽 𝗈𝗋𝖽𝖾𝗋𝗌 † ٫
...
return LuaTele.sendText(msg_chat_id,msg_id,'• 𝗒𝗈𝗎 𝗌𝗁𝗈𝗎𝗅𝖽 𝗎𝗌𝖾 𝗅𝗂𝗌𝗍 𝖼𝗈𝗇𝗍𝗋𝗈𝗅 𝗈𝗋𝖽𝖾𝗋𝗌 •',"md",false, false, false, false, reply_markup)
elseif text == 'م3' then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︰هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
...
if not Redis:get(TheMaRVeL.."MaRVeL:Sasa:Jeka"..msg_chat_id) then
...
Redis:setex(TheMaRVeL.."MaRVeL:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheMaRVeL.."MaRVeL:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheMaRVeL.."MaRVeL:Name:Bot") or "مارفل") then
local NamesBot = (Redis:get(TheMaRVeL.."MaRVeL:Name:Bot") or "مارفل")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات مارفل بعدين اجاوبك",
...
x = x + 1
Redis:srem(TheMaRVeL..'MaRVeL:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheMaRVeL)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⌔︰البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheMaRVeL..'MaRVeL:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheMaRVeL..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheMaRVeL..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheMaRVeL..'MaRVeL:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheMaRVeL.."MaRVeL:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheMaRVeL.."MaRVeL:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheMaRVeL.."MaRVeL:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheMaRVeL.."MaRVeL:Status:Games"..msg.chat_id) then
Redis:del(TheMaRVeL.."MaRVeL:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheMaRVeL.."MaRVeL:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheMaRVeL.."MaRVeL:Status:Games"..msg.chat_id) then
Redis:del(TheMaRVeL.."MaRVeL:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheMaRVeL.."MaRVeL:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheMaRVeL.."MaRVeL:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheMaRVeL.."MaRVeL:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheMaRVeL.."MaRVeL:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheMaRVeL.."MaRVeL:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheMaRVeL.."MaRVeL:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
if text == '/start' then
Redis:sadd(TheMaRVeL..'MaRVeL:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheMaRVeL.."MaRVeL:Start:Bot") then
local CmdStart = '*\n⌔︰أهلآ بك في بوت '..(Redis:get(TheMaRVeL.."MaRVeL:Name:Bot") or "مارفل")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheMaRVeL.."MaRVeL:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(TheMaRVeL.."MaRVeL:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheMaRVeL.."MaRVeL:Start:Bot") 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '٬ 𝖼𝗅𝗂𝖼𝗄 𝗍𝗈 𝗌𝗎𝖻𝗌𝖼𝗋??𝖻𝖾 † ٫ ', url = 't.me/'..Redis:get(TheMaRVeL..'MaRVeL:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗉𝗋𝗈 🦎.*',"md",false, false, false, false, reply_markup)
end
local list = Redis:smembers(TheMaRVeL.."MaRVeL:List:Rd:Sudo")
text = "\n📝︰قائمة ردود المطور \n━─━─━─━─━─━─━\n"
...
if not msg.ControllerBot then
if Redis:get(TheMaRVeL.."MaRVeL:TwaslBot") and not Redis:sismember(TheMaRVeL.."MaRVeL:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheMaRVeL.."MaRVeL:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheMaRVeL.."MaRVeL:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheMaRVeL..'MaRVeL:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⌔︰تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheMaRVeL..'MaRVeL:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheMaRVeL.."MaRVeL:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheMaRVeL..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMaRVeL.."MaRVeL:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheMaRVeL.."MaRVeL:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheMaRVeL then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheMaRVeL..'MaRVeL:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheMaRVeL.."MaRVeL:Lock:edit"..data.chat_id) then
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheMaRVeL.."MaRVeL:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheMaRVeL.."MaRVeL:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheMaRVeL.."MaRVeL:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheMaRVeL.."MaRVeL1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheMaRVeL.."MaRVeL:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheMaRVeL.."MaRVeL:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMaRVeL.."MaRVeL:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMaRVeL.."MaRVeL1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMaRVeL.."MaRVeL:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"⌔︰ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMaRVeL.."MaRVeL:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"⌔︰ارسل لي الرد الان", 'md', true)
end
end
...
keyboard.inline_keyboard = {
{
{text = '٬ 𝗁𝗂𝖽𝖾 𝗂𝗍 † ٫', callback_data =IdUser..'/delAmr'}, 
},
{
...
Redis:incrby(TheMaRVeL.."MaRVeL:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Link"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"⌔︰تم قفـل الروابط").Lock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/lock_spam') then
local UserId = Text:match('(%d+)/lock_spam')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMaRVeL.."MaRVeL:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMaRVeL.."MaRVeL:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMaRVeL.."MaRVeL:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMaRVeL.."MaRVeL:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:Link"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMaRVeL.."MaRVeL:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheMaRVeL.."MaRVeL:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheMaRVeL.."MaRVeL:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheMaRVeL.."MaRVeL:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheMaRVeL..'MaRVeL:'..lock..UserId[2],"del")    
end
...
{
{text = '- ⤹ ٰ𝖱ِ𝖊َ𝖳ِ𝖚ٍ𝐑ِɴ 🔁. ', data =IdUser..'/'.. 'NextSeting'}
},
{
{text = '𝗆𝖺𝗂𝗇 𝗅𝗂𝗌𝗍 🦖.', data = IdUser..'/helpall'},
},
...
{
{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},
},
}
}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheMaRVeL.."MaRVeL:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '𝘳ꫀ𝓽ꪊ𝘳ꪀ ➡️', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"⌔︰تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMaRVeL.."MaRVeL:SilentGroup:Group"..ChatId) 
