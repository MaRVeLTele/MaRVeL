...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '٬ 𝖼𝗅𝗂𝖼𝗄 𝗍𝗈 𝗌𝗎𝖻𝗌𝖼𝗋𝗂𝖻𝖾 † ٫ ', url = 't.me/II_T2'}, },}}
...
{
{text = '٬ 𝙊𝙗𝙖 𝙇𝙖𝙍𝙞𝙘𝙖 🕷 ٫', url = "https://t.me/II_T2"}
},
}
...
{
{text = '٬ 𝙊𝙗𝙖 𝙇𝙖𝙍𝙞𝙘𝙖 🕷 ٫',url="t.me/II_T2"}
},
}
local msg_id = msg.id/2097152/0.5
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '٬ 𝖼𝗅𝗂𝖼𝗄 𝗍𝗈 𝗌??𝖻𝗌𝖼𝗋𝗂𝖻𝖾 † ٫ ', url = 't.me/'..Redis:get(TheMaRVeL..'MaRVeL:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n 𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗉𝗋𝗈 🦎.*',"md",false, false, false, false, reply_markup)
end
...
keyboard.inline_keyboard = {
{
{text = '𝗂𝗇𝗍𝖾𝗋𝗇𝖺𝗍𝗂𝗈𝗇𝖺𝗅 𝗉𝗋𝗈𝗀𝗋𝖺𝗆𝗆𝖾𝗋 †', url = "https://t.me/Too_9"},{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝗅𝖺𝗋𝗂𝖼𝖺 †', url = "https://t.me/II_T2"}
},
{
...
if text == (Redis:get(TheMaRVeL.."MaRVeL:Name:Bot") or "لاريكا") then
local NamesBot = (Redis:get(TheMaRVeL.."MaRVeL:Name:Bot") or "لاريكا")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات لاريكا بعدين اجاوبك",
...
local CmdStart = '*\n⌔︰أهلآ بك في بوت '..(Redis:get(TheMaRVeL.."MaRVeL:Name:Bot") or "لاريكا")..
